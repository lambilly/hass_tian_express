"""Sensor platform for Tian Express integration."""
import logging
import asyncio
...
async def async_setup_entry(
    ...
    coordinator = TianExpressDataUpdateCoordinator(
        hass,
        api_key,
        express_number,
        express_name,
    ...
    async_add_entities([TianExpressSensor(coordinator, config_entry)])

class TianExpressDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching Tian Express data."""
...
class TianExpressSensor(CoordinatorEntity, SensorEntity):
    """Representation of a Tian Express Sensor."""
