"""Config flow for Tian Express integration."""
import logging
...
class TianExpressConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Tian Express."""
    ...
    def async_get_options_flow(config_entry):
        ...
        return TianExpressOptionsFlow(config_entry)

class TianExpressOptionsFlow(config_entries.OptionsFlow):
    """Handle options flow for Tian Express."""
